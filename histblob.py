...
sample_1 = make_gaussian_blobs(n_matrices=n_matrices, n_dim=n_dim, class_sep=delta, class_disp=sigma, random_state=random_state)[0]
...
qgauss = np.percentile(np.random.normal(2.33, 0.78, n_matrices), percs)
...
plt.subplot(326)
plt.plot(qgauss, qgaussprac, ls="", marker="o")
